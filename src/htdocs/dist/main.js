...
createElement(
    ...
    createElement(
        _uiLibrary.Dialog,
        {
            ...
            banner: createElement('img', { src: 'Dialog/dialog-banner.png', alt: '' }),
            size: 'sm',
            onClose: handleClose,
            form: {
        ...
        createElement(
            _uiLibrary.Paragraph,
            null,
            'Would you like to receive security-related, technical and general product information in your personal Plesk Newsletter?'
        ),
        createElement(_uiLibrary.FormFieldText, { name: 'name', label: 'Your email address', size: 'fill', required: true }),
        createElement(
            _uiLibrary.Paragraph,
            null,
            'By clicking the "Subscribe" button below, I agree to receiving personalized Plesk newsletters. Plesk International GmbH and its affiliates may store and process the data I provide for the purpose of delivering the newsletter according to the',
            ' ',
            createElement(
                _uiLibrary.Link,
